...
export const { setNavItems, setSelectedModel, setShouldFetchData, setShouldFetchDataTrue } = navItemsSlice.actions;

export const selectNavItems = (state: RootState) => state.navItems.navItems;
export const selectSelectedModel = (state: RootState) => state.navItems.selectedModel;
